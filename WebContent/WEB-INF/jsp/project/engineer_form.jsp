...
<form name="detail_form" method="post" action="save_engineer.do">
...
<table class="table table-striped">
  ...
  <tr>
	  <td>엔지니어 명</td>
	  <td><input name="name" value="${project.engineer.name}"></td>
  </tr>
  <tr>
	  <td>전화번호</td>
	  <td><input name="tel_no" value="${project.engineer.tel_no}"></td>
  </tr>
  <tr>
	  <td>E-Mail</td>
	  <td><input name="email" value="${project.engineer.email}"></td>
  </tr>
